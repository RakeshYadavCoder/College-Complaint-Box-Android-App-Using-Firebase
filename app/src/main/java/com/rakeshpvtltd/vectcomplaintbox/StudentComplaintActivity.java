...
public class StudentComplaintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    if (awesomeValidation.validate())
                    {
                        ...
                        Intent i=new Intent(StudentComplaintActivity.this, StudentComplaintConformation.class);
                        startActivity(i);
                        finish();
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i=new Intent(StudentComplaintActivity.this, HomeActivity.class);
                startActivity(i);
                finish();
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(StudentComplaintActivity.this, HomeActivity.class));
        finishAffinity();
        finish();
