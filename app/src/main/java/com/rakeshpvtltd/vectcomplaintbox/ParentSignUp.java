        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (awesomeValidation.validate())
                {
                    ...
                    String Parent_email = e1.getText().toString();
                    String Student_id = e2.getText().toString();
                    String Parent_pass = e3.getText().toString();
                    String Parent_re_pass = e4.getText().toString();

                    Query query = FirebaseDatabase.getInstance().getReference().child("Parent").orderByChild("id").equalTo(Student_id);
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.getChildrenCount()>0){
                                ...
                                firebaseAuth.createUserWithEmailAndPassword(Parent_email,Parent_re_pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    @Override
...
//                                                         Log.d("myTag", "Email sent");
                                                        ...
                                                        ParentData data = new ParentData(Parent_email,Student_id);
                                                        ...
                                                        Intent i=new Intent(ParentSignUp.this, ParentEmailVarification.class);
                                                        i.putExtra("EMAIL",Parent_email);
