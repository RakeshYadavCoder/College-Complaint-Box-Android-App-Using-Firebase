...
public class AdminEmailVerfication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_email_verfication);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(AdminEmailVerfication.this, AddNewAdmin.class);
                startActivity(i);
                finish();
            }
        });
        t2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Intent i=new Intent(AdminEmailVerfication.this, AdminLogin.class);
                startActivity(i);
                finish();
            }
        });
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(AdminEmailVerfication.this, AddNewAdmin.class));
        finishAffinity();
        finish();
