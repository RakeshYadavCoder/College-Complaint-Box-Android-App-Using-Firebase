...
//                                                    e2.setText("");
//                                                    progressDialog.hide();
//                                                    Intent i=new Intent(StudentLogin.this, StudentComplaintActivity.class);
//                                                    startActivity(i);
//                                                    finish();
//                                                }
//                                                else
//                                                {
//                                                    progressDialog.hide();
//                                                    Toast.makeText(StudentLogin.this, "Please Verify Your Email", Toast.LENGTH_SHORT).show();
//                                                    e1.setText("");
//                                                    e2.setText("");
//                                                }
//
...
//                                            {
//                                                progressDialog.hide();
//                                                Toast.makeText(StudentLogin.this, "Email Id or Password is Wrong", Toast.LENGTH_SHORT).show();
//                                                e1.setText("");
//                                                e2.setText("");
//                                            }
//                                        }
...
//                            e1.setText("");
//                            e2.setText("");
//                            Toast.makeText(StudentLogin.this, "Please Check Your Internet Connectivity", Toast.LENGTH_SHORT).show();
//
//                        }
//                    });
//
...
//                else
//                {
//                    Toast.makeText(StudentLogin.this, "Please Enter Valid Details", Toast.LENGTH_SHORT).show();
//                    e1.setText("");
//                    e2.setText("");
//                }
//            }
//        });
        ...
        t2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Intent i=new Intent(StudentLogin.this, StudentForgotPassword.class);
                startActivity(i);
            }
        });
