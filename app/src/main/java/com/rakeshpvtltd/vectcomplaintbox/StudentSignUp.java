        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (awesomeValidation.validate())
                {
                    ...
                    String Student_email = e1.getText().toString();
                    String Student_id = e2.getText().toString();
                    String Student_pass = e3.getText().toString();
                    String Student_re_pass = e4.getText().toString();

                    Query query = FirebaseDatabase.getInstance().getReference().child("Student").orderByChild("id").equalTo(Student_id);
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.getChildrenCount()>0){
                                ...
                                firebaseAuth.createUserWithEmailAndPassword(Student_email,Student_re_pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    @Override
...
//
                                                        ...
                                                        StudentData data = new StudentData(Student_email,Student_id);
                                                        databaseReference.child(currentuser).setValue(data);
                                                        progressDialog.hide();
//                                                        databaseReference.child(Student_id).setValue(data);
                                                        e1.setText("");
                                                        e2.setText("");
                                                        e3.setText("");
                                                        e4.setText("");
                                                        ...
                                                        Intent i=new Intent(StudentSignUp.this, StudentEmailVerification.class);
                                                        i.putExtra("EMAIL",Student_email);
                                                        i.putExtra("NUMBER",Student_id);
                                                        startActivity(i);
                                                        finish();
                                                    }
                                                    else {
